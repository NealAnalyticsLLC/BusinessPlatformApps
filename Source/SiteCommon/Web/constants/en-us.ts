export const EN_US = {
    ...
    INIT_GETTING_STARTED_CONNECTED_CUSTOMER_SUBSCRIPTION: `Connected Customer Subscription`,
    ...
    INIT_SKUMAX_SUBTITLE: `Welcome to the SKU Max solution template.`,
    INIT_SKUMAX_TEMPLATE_NAME: `SKU Max Solution Template`,
    INIT_SKUMAX_AZURE_PRICING_CALCULATOR_URL: `https://azure.microsoft.com/en-us/pricing/calculator/`,
    INIT_SKUMAX_AZURE_PRICING_COST: `By clicking next and deploying the template, you authorize Microsoft to create Azure resources on your subscription and bill based on their respective pricing rates. The approximate base cost of the Azure resources used by this template is $4.33 a day, and every 1,000 tweets will incur an additional cost of approximately $0.8. These costs are estimates only and subject to change.`,
    INIT_SKUMAX_AZURE_PRICING_URL: ``,
    INIT_SKUMAX_CONNECTED_CUSTOMER_PRICING_CALCULATOR_URL: `https://azure.microsoft.com/en-us/pricing/calculator/`,
    INIT_SKUMAX_CONNECTED_CUSTOMER_PRICING_COST: `By clicking next and deploying the template, you authorize Microsoft to create Azure resources on your subscription and bill based on their respective pricing rates. The approximate base cost of the Azure resources used by this template is $4.33 a day, and every 1,000 tweets will incur an additional cost of approximately $0.8. These costs are estimates only and subject to change.`,
    INIT_SKUMAX_CONNECTED_CUSTOMER_PRICING_URL: ``,
    INIT_SKUMAX_SQL_SUBTITLE: `Set up a connection to SQL to store so we can store results of Machine Learning experiments`,
    INIT_SKUMAX_SQL_TITLE: `Set up a connection to SQL`,
    INIT_SKUMAX_RESOURCE_GROUP: `David_McClellan`,
